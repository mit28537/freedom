        ...
        <form method="post" action="engineer_register.php">
            <?php
                print'<table border=1 style="float:left; margin:5px;width:40%;">';
                    print'<tr>';
                        print'<td class="pj_header">案件番号</td>';
                        print'<td style="width:70%;">'. $arrayData['project_id'] .'</td>';
                    print'</tr>';
                    print'<tr>';
                        print'<td class="pj_header">案件名</td>';
                        print'<td style="width:70%;">'. $arrayData['project_subject'] .'</td>';
                    print'</tr>';
                    print'<tr>';
                        print'<td class="pj_header">案件種別</td>';
                        print'<td style="width:70%;">'. $projectKindArray['mst_name'].'</td>';
                    print'</tr>';
                    print'<tr>';
                        print'<td class="pj_header">業種</td>';
                        print'<td style="width:70%;">'. $projectIndustryArray['mst_name'] .'</td>';
                    print'</tr>';
                    print'<tr>';
                        print'<td class="pj_header">スキル</td>';
                        print'<td style="width:70%;">'. $arrayData['project_skill'] .'</td>';
                    print'</tr>';
                    print'<tr>';
                        print'<td class="pj_header">金額</td>';
                        print'<td style="width:70%;">'. $arrayData['project_price'] .'</td>';
                    print'</tr>';
                    print'<tr>';
                        print'<td class="pj_header">勤務地</td>';
                        print'<td style="width:70%;">'. $arrayData['project_location'] .'</td>';
                    print'</tr>';
                    print'<tr>';
                        print'<td class="pj_header">案件内容</td>';
                        print'<td style="width:70%;">'. $arrayData['project_detail'] .'</td>';
                    print'</tr>';
                    print'<br />';
                    print'<br />';
                    print'<td style="text-align:center;"><input type="button" onclick="history.back()" value="戻る"></td>';
                    print'<td style="width:70%;text-align:center;"><a href="engineer_register.php?project_id= '.$arrayData['project_id'].'" class="design_btn">この案件にエントリーする</a></td>';
                print'</table>';
                print'<br />';
            ?>
        </form>
